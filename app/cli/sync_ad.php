...
try {
	...
	$ins = $pdo->prepare("
		...
		VALUES (:nome, :login, :email, 'ad', :dn, :upn, :department, :title, :company, :office, :phone, :employeeNumber, :uac, :lockoutTime, :is_active, GETDATE(), GETDATE())
	");
	...
	$upd = $pdo->prepare("
		UPDATE users SET
		  ...
		  userAccountControl=:uac, lockoutTime=:lockoutTime, origem='ad', is_active=:is_active,
