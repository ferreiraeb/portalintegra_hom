...
private function pageFetch(string $op, string $tipo, array $filters, int $pp, int $p): array
{
    ...
    private function exportFromDb(): void
    {
        ...
        switch ($tab) {
            case 'sys':
                $tipo     = 'ONLY_SYS';
                $columns  = 'ProdutoCodigo, ProdutoReferencia, ProdutoDescricao, NCMCodigo, NCMIdentificador';
            ...
            default: // 'match'
                $tipo     = 'MATCH';
                $columns  = 'ProdutoCodigo, ProdutoReferencia, ProdutoDescricao, NCMCodigo, NCMIdentificador, ValorPlanilha, Overprice, IndiceParaCusto, PrecoPublico, PrecoSugerido, PrecoGarantia, PrecoReposicao';
