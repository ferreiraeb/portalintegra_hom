...
class AgroMasseyControllerGustavo
{
    ...
    public function index()
    {
        ...
        switch ($action) {
            ...
            case 'update_chunk':  return $this->ajaxUpdateChunk();
    ...
    {
        return render_page('agro/tabela_massey_gustavo.php', [
            'erro'             => null,
            'rows'             => [],
            'soSistema'        => [],
            'soPlanilha'       => [],
...
private function pageFetch(string $op, string $tipo, array $filters, int $pp, int $p): array
{
    ...
    /* ================== AJAX: UPDATE CHUNK (Atualizar Valores faseado) ================== */
