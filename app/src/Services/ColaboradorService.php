...
class ColaboradorService
{
    ...
    public function search(string $termo): array
    {
        ...
        $stmt = $pdo->prepare(
            "SELECT CODPESSOA, NOMECOMPLETO, CPF, CARGO, EMPRESA, UNIDADE, STATUS
             FROM SIRH.VW_RH_COLABORADORES
             WHERE STATUS = 'ATIVO'
               AND (UPPER(NOMECOMPLETO) LIKE :like OR UPPER(CODPESSOA) LIKE :like2 OR CPF LIKE :like3)
     ...
     * @return array[]
     */
    public function getItensAtivos(string $codpessoa, ?string $cpf = null): array
    {
