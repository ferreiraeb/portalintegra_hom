      ...
      <div class="card-body">
		...
		<div class="form-row">
          ...
          <div class="form-group col-md-2">
            <label class="form-label mb-0">Markup</label>
          ...
          <div class="form-group col-md-2">
            <label class="form-label mb-0">Fator de Importação</label>
                 ...
                 <table class="table table-sm table-hover table-bordered">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th class="text-right">ValorPlanilha (R$)</th><th class="text-right">Markup</th><th class="text-right">Fator Importação</th>
