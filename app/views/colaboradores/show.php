  ...
  <div class="container-fluid" style="max-width:900px;">
    ...
    <div class="card card-primary">
      ...
      <div class="card-footer d-flex align-items-center">
        <a href="<?= base_url('colaboradores') ?>" class="btn btn-secondary">
          <i class="fas fa-arrow-left mr-1"></i>Voltar à lista
        </a>
        <a href="<?= e(base_url('colaboradores/' . urlencode((string)($c['CODPESSOA'] ?? '')) . '?export=pdf')) ?>"
           class="btn btn-outline-secondary ml-2">
          <i class="fas fa-file-pdf mr-1"></i>Exportar em PDF
        </a>
      </div>
    </div>
