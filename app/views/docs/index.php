      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <ol class="mb-0">
            ...
            <li><a href="#mining-di">Mining → Análise DI</a></li>
            <li><a href="#mining-getman">Mining → Tabela Getman</a></li>
...
/database/migrations/
  001_init.sql
        ...
        <ul>
          ...
          <li><strong>Sidebar:</strong> logo (classe <code>.portal-logo</code>, evitando <code>.brand-image</code> do AdminLTE), grupos “Início”, “Usuários”, “Mining”.</li>
        ...
        <ul>
          ...
          <li><strong>Modal:</strong> <em>Users, Mining → Análise DI, Mining → Tabela Getman</em> com 0/1/2.</li>
        </ul>

        <!-- 8) MINING DI -->
        <h4 id="mining-di" class="mt-4">8) Mining → Análise DI</h4>
        <ul>
        ...
        <!-- 9) MINING GETMAN -->
        <h4 id="mining-getman" class="mt-4">9) Mining → Tabela Getman</h4>
        <ul>
          <li><strong>Acesso:</strong> permissão <code>mining.tabela_getman</code> = <strong>2</strong>.</li>
        ...
        <ul>
          ...
          <li>Paginação nas tabelas do Mining quando arquivos forem grandes.</li>
          <li>Perfis (roles) agregando permissões (admin, operador, auditor etc.).</li>
          <li>Outras marcas em Mining reaproveitando o pipeline da Getman.</li>
        </ul>
...
- Mining → Análise DI: service AnaliseDIService (NF/DI XML, XPath, DealerNet cross‑db [db].dbo.Tabela), controller exige perm ≥1; ações corrigir/persistir exigem 2.
- Mining → Tabela Getman: parser XLSX, cruzamento com DealerNet, abas (Relação, Apenas DealerNet, Apenas Planilha), export CSV, “Atualizar Valores” (auditoria + EXEC proc).
...
- Reaproveitar pipeline de Mining para outras marcas (ajustar parser e consultas).
