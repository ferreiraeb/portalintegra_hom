...
(function () {
  ...
  var BASE       = <?= json_encode(base_url('drilling/tabela-boart')) ?>;
  ...
  if (form) {
    form.addEventListener('submit', function () {
      ...
      /* Deixa o form submeter normalmente; modal some quando a nova página carrega. */
    });
  }
