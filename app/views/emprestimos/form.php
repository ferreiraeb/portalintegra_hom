      ...
      <form method="post" action="<?= base_url('emprestimos/criar') ?>">
        ...
        <div class="card-body">
          ...
          <div class="form-group position-relative">
            ...
            <input type="hidden" name="colaborador_cpf" id="colaborador_cpf"
                   value="<?= $v('colaborador_cpf') ?>">
...
(function () {
  ...
  var hiddenCpf   = document.getElementById('colaborador_cpf');
  var info        = document.getElementById('colab_info');
  var debounce    = null;
  var baseUrl     = <?= json_encode(base_url('colaboradores/autocomplete')) ?>;
  ...
  function renderItem(item) {
    ...
    el.addEventListener('mousedown', function (e) {
      ...
      hiddenCpf.value  = item.cpf_digits || '';
  ...
  busca.closest('form').addEventListener('submit', function (e) {
    ...
    if (hiddenNome.value === '' || hiddenCod.value === '' || hiddenCpf.value === '') {
      e.preventDefault();
