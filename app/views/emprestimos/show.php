    ...
    <div class="card">
      ...
      <div class="card-body">
        <dl class="row">
          ...
          <dd class="col-sm-8">
            <a href="<?= base_url('colaboradores/' . urlencode((string)($emp['colaborador_codpessoa'] ?? ''))) ?>">
          ...
          <dd class="col-sm-8"><?= format_date_br($emp['data_entrega'] ?? null) ?></dd>
          <dt class="col-sm-4">Prev. devolução</dt>
          <dd class="col-sm-8"><?= format_date_br($emp['data_prevista_devolucao'] ?? null) ?></dd>
          <?php if (!empty($emp['data_devolucao'])): ?>
          <dt class="col-sm-4">Data devolução</dt>
          <dd class="col-sm-8"><?= format_date_br($emp['data_devolucao']) ?></dd>
          <?php endif; ?>
