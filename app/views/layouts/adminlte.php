      ...
      <nav class="mt-2">
		...
		<?php
			$cadastroMenuOpen = starts_with_path('itens', $currentPath)
			                 || starts_with_path('emprestimos', $currentPath)
		...
		<li class="nav-item has-treeview<?= $cadastroMenuOpen ? ' menu-open' : '' ?>">
		  ...
		  <ul class="nav nav-treeview"<?= $cadastroMenuOpen ? ' style="display:block;"' : '' ?>>
			<li class="nav-item">
			  <a href="<?= base_url('itens') ?>" class="nav-link<?= starts_with_path('itens', $currentPath) ? ' active' : '' ?>">
				<i class="far fa-circle nav-icon"></i><p>Itens</p>
			  </a>
			</li>
			<li class="nav-item">
			  <a href="<?= base_url('emprestimos') ?>" class="nav-link<?= (starts_with_path('emprestimos', $currentPath) || starts_with_path('reservas', $currentPath)) ? ' active' : '' ?>">
				<i class="far fa-circle nav-icon"></i><p>Empréstimos</p>
			  </a>
			</li>
		  </ul>
		</li>
