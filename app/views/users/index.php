    ...
    <form method="get" action="<?= base_url('users') ?>" id="frmUsersFilter">
      ...
      <div class="card">
        ...
        <div class="card-header d-flex align-items-center">
          ...
          ?>
          <a href="<?= e(base_url('users') . '?' . http_build_query($exportParams)) ?>"
          ...
          <table class="table table-hover table-sm mb-0">
            ...
            <?php if (!empty($users)): ?>
              ...
              <tr>
                <td><?= e($u['nome'] ?? '') ?></td>
                <td><?php
                  if ($u['colaborador_nome'] !== null) {
                    echo e($u['colaborador_nome']);
                    if (($u['colaborador_status'] ?? '') !== 'ATIVO') {
                      echo ' <span class="text-danger small font-weight-bold">(inativo)</span>';
                    }
                  } else {
                    echo '—';
                  }
